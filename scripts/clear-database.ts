...
async function main() {
  ...
  try {
    ...
    // Nota: Os modelos precisam existir no Prisma para usar deleteMany
    // await prisma.costCenterWallet.deleteMany(); // Modelo não encontrado
    ...
    // await prisma.costCenter.deleteMany(); // Modelo não encontrado
