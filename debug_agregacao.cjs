...
// Ler o arquivo JSON com todas as vendas
const vendasData = JSON.parse(fs.readFileSync('vendas_agosto_2025.json', 'utf8'));

console.log('=== DEBUG AGREGAÇÃO - SIMULANDO NOSSA LÓGICA COMPLETA ===\n');

// Simular a lógica da nossa API com todas as vendas
...
if (vendasData.data && Array.isArray(vendasData.data)) {
  console.log(`Processando ${vendasData.data.length} vendas...\n`);
