...
export const DashboardSummary = React.memo(({ totais, metas, vendedores }: DashboardSummaryProps) => {
  ...
  return (
    <div className={`ios26-grid ${isMobile ? 'grid-cols-1' : 'md:grid-cols-2 lg:grid-cols-4'}`}>
      ...
      <div className="ios26-metric-card">
        ...
        <div className={`space-y-4 ${isMobile && collapsedSections.lucro ? 'hidden' : 'block'}`}>
          <div className={cn(
            "ios26-currency-large",
            lucro >= 0 ? "ios26-value-positive" : "ios26-value-negative"
          )}>
