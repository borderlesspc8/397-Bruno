...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('🔍 [CanaisVendas Direct API] Buscando vendas em:', vendasUrl);
    ...
    console.log(`📊 [CanaisVendas Direct API] Total de vendas recebidas: ${vendas.length}`);
    ...
    console.log(`📊 [CanaisVendas Direct API] Vendas filtradas: ${vendasFiltradas.length} de ${vendas.length}`);
    ...
    console.log(`📊 [CanaisVendas Direct API] Canais consolidados encontrados:`, {
    ...
    console.log(`📊 [CanaisVendas Direct API] Retornando dados:`, {
    ...
    console.error("Erro ao processar dados de canais de vendas por unidade (direct):", error);
    return NextResponse.json(
