...
export function Navbar() {
  ...
  return (
    <div className="free-navbar-container relative z-50">
            ...
            <AnimatePresence>
              {menuOpen && (
                <motion.div
                  ...
                  className="dropdown-menu absolute top-full left-0 mt-2 w-56 rounded-2xl border bg-popover p-1 shadow-xl z-[100]"
                  style={{
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="mobile-menu md:hidden border-b bg-background/90 ios26-card relative z-40"
          >
      ...
      {/* Adiciona estilo de animação e z-index */}
      <style jsx global>{`
        @keyframes fadeIn {
        ...
        .free-navbar-container .dropdown-menu {
          z-index: 100;
        }
        
        .free-navbar-container .mobile-menu {
          z-index: 40;
        }
        
        /* Garantir que o navbar fique acima de outros elementos */
        .free-navbar-container * {
          position: relative;
        }
